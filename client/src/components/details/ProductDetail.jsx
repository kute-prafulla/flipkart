        ...
        <>
         <Typography>{product.title.longTitle}</Typography>
                        <Typography style={{ marginTop: 5, color: '#878787', fontSize: 14 }}>
                           ...
                           <Typography><StyledBadge />Special PriceGet extra 9% off (price inclusive of cashback/coupon)T&C </Typography>
                           <Typography><StyledBadge />Buy for 100 get ₹225 off your Next Buy</Typography>
                            </SmallText>
                            <Table>
                                <TableBody>
                                    <ColumnText >
                                    ...
                                    <ColumnText >
                                        ...
                                        <TableCell>
                                            ...
                                            <Typography>GST invice avilable</Typography>
